const Hero = ()=>{
    ...
    <div className="bg-[#171A2D] min-w-screen min-h-screen flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center">
            <h1 className="font-extrabold m-4 text-white text-7xl"><span className="font-extrabold bg-linear-to-r from-red-500 to-yellow-400 bg-clip-text text-transparent">F1 DASHBOARD</span> Hoşgeldiniz!</h1>
